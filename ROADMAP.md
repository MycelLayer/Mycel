...
3. conservative merge authoring now covers basic move/reorder plus insert/delete composition, but broader nested/reparenting cases and richer conflict classification still require manual curation
