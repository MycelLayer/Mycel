...
3. expand `M3` reader workflows carefully on top of the now-usable accepted-head inspection, render, editor-admission-aware profile base, and bounded viewer score surfaces while keeping broader governance persistence, profile ergonomics, and final independent dual-role role-assignment closure explicit
...
| 9. Views and Head Selection | Mostly done | `M3` | deterministic selector core, named fixed-profile selection, separate editor/view admission-aware inspect/render flows, and bounded viewer score channels in head inspection exist; broader governance persistence and final independent dual-role role-assignment closure remain |
