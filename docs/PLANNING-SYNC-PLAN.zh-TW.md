...
- `sync web`：只同步 GitHub Pages。包含 `docs/index.html`、各語系 landing pages 與 `docs/progress.html` 等 HTML 表面。
...
7. 若目前建議起手的 issue 已改變，同步刷新 `docs/index.html` 與各語系 landing pages 中的 contributor-entry 連結
