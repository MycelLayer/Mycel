...
- `sync issue`：同步 GitHub Issues，以及 GitHub Pages 入口頁上的 contributor-entry issue 連結，例如 `pages/index.html`、`pages/zh-TW/index.html` 與 `pages/zh-CN/index.html`。
...
- [`pages/index.html`](../pages/index.html)、[`pages/zh-TW/index.html`](../pages/zh-TW/index.html) 與 [`pages/zh-CN/index.html`](../pages/zh-CN/index.html) 中的 contributor-entry issue 連結
...
- `pages/index.html` 與各語系 landing pages 中的 contributor-entry issue 連結也是公開 contributor 入口摘要，必須指向目前仍有效的 `ai-ready` 任務。
