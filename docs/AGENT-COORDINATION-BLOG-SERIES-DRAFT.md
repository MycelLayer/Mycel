...
- Token usage summaries and commit trailers are workflow surfaces, not side metadata, because they preserve cost, ownership, model context, and landed boundaries across sessions.

What this article should do:

- explain why usage summaries belong in workcycle closeout rather than in a hidden telemetry silo
- explain why commit trailers such as `Agent-Id`, `Model`, `Reasoning-Effort`, and `Token-Spent` improve auditability and continuation
- connect workflow metadata to both human readability and agent reusability
...
### 6. Handoffs Should Be First-Class Artifacts
...
### 7. Workcycles Beat Vague “In Progress” State
...
### 8. Git Ownership Is a Coordination Primitive
...
### 9. Stale-Active Agents Are a Real Operational Failure Mode
...
### 10. Human Control Matters More After the Agents Get Better
...
### 11. What Existing OSS Multi-Agent Stacks Solve, and What They Mostly Do Not
...
### 12. From Internal Process to Reusable Coordination Layer
