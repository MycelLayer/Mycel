...
- `sync issue`：同步 GitHub Issues，以及 GitHub Pages 入口页上的 contributor-entry issue 链接，例如 `pages/index.html`、`pages/zh-TW/index.html` 和 `pages/zh-CN/index.html`。
...
- [`pages/index.html`](../pages/index.html)、[`pages/zh-CN/index.html`](../pages/zh-CN/index.html) 和 [`pages/zh-TW/index.html`](../pages/zh-TW/index.html) 中精选的 contributor-entry issue 链接
...
- `pages/index.html`、`pages/zh-CN/index.html` 和 `pages/zh-TW/index.html` 中精选的 issue 链接也是公开 contributor 入口摘要，必须指向当前仍然有效的 `ai-ready` 任务。
...
- 对齐后的 GitHub Issues 和 landing-page issue 入口，在 `sync issue` 到门槛时更新
...
3. `doc` 必须运行 `scripts/check-plan-refresh.sh`
4. 如果 `sync doc` 到门槛，refresh `ROADMAP.md`、`IMPLEMENTATION-CHECKLIST.*`、`docs/PROGRESS.md` 和相关 README 文案
5. 如果 `sync issue` 到门槛，对齐 GitHub Issues 和各语言 landing-page issue 入口
