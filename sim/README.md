...
- `apps/mycel-cli/tests/common/mod.rs` provides shared CLI test helpers for command execution, JSON parsing, report loading, exit-code checks, JSON status checks, and stdout/stderr assertions
