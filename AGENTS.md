...
- Use `scripts/check-doc-refresh.sh` to check that 20-commit roadmap/checklist cadence before or after a work batch; if it reports `due`, update `ROADMAP.md` and the implementation checklist files in the next docs sync.
