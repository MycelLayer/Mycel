...
- [ ] 擴大 session、capability 與 error-path interop coverage，超出目前 positive-path、optional-message、sender-validation、explicit `ERROR`-only、reachability 與 messages-after-BYE proof set。
