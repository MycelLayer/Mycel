...
- [ ] Expand session, capability, and error-path interop coverage past the current positive-path, optional-message, sender-validation, explicit `ERROR`-only, reachability, and messages-after-BYE proof set.
