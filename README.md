...
- Current topology-validation scope: `validate sim/topologies --json` validates the topology set as a repo-scoped input and surfaces related peer, test-case, and report counts alongside the topology counts
